    ...
    public void setListener(){
        ...
        bHapus.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                int pilihan = JOptionPane.showConfirmDialog(null,"Yakin untuk menghapus?","Konfirmasi hapus", JOptionPane.YES_NO_OPTION);
                if(pilihan==0){
                    if (i>=0){
                        try{
        ...
        bUbah.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (i>=0){
                    ...
                    penerbit.setId(Integer.parseInt(model.getValueAt(i, 1).toString()));
